...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        ...
        alert("Suma", f"el resultado es {resultado}") 
    ...
    def btn_restar_on_click(self):
        ...
        alert("resta", f"el resultado es {resultado}") 
    ...
    def btn_multiplicar_on_click(self):
        ...
        alert("multiplicar", f"el resultado es {resultado}") 
    ...
    def btn_dividir_on_click(self):
        ...
        alert("division", f"el resultado es {resultado:.2f}") 
